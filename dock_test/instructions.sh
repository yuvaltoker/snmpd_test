...
sleep 15
while true; do
#    snmpset -v2c -c public testing_snmpd:1662 MY-SNMP-TUTORIAL-MIB::batteryObject.0 i $x >> file.log
#    snmpset -v2c -c public testing_snmpd:1662 NET-SNMP-TUTORIAL-MIB::nstAgentSubagentObject.0 i $x >> file.log
#    snmpget -v2c -c public testing_snmpd:1662 MY-TUTORIAL-MIB::batterySubagentObject.0 >> file.log
